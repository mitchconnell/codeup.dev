...
// $query = "INSERT INTO users (email, name) VALUES ('jason@codeup.com', 'Jason Straughan');";
...
$parks = [
	...
	[
		...
		'area_in_acres' => '242,755.94 acres',
	],
	[
		'name' => 'Big Bend',
		'location' => 'Texas',
		...
		'area_in_acres' => '801,163.21 acres',
	],
	[
		'name' => 'Biscayne',
		'location' => 'Florida',
		...
		'area_in_acres' => '172,924.07 acres',
	],
	[
		'name' => 'Black Canyon',
		'location' => 'Colorado',
	...
	[
		...
		'date_established' => '1928-2-25',
		'area_in_acres' => '35,835.08 acres',
	],
	[
		'name' => 'Canyonlands',
		'location' => 'Utah',
		...
		'area_in_acres' => '337,597.83 acres',
	],
	[
		'name' => 'Capitol Reef',
		'location' => 'Utah',
...
foreach ($parks as $park) {
	$description = $mysqli->real_escape_string($park['description']); 
    $query = "INSERT INTO parks (name, location, description, date_established, area_in_acres) VALUES (";
    $query .= "'" . $park['name'] . "', ";
    $query .= "'" . $park['location'] . "', ";
    $query .= "'" . $description . "', ";
    $query .= "'" . $park['date_established'] . "', ";
    $query .= "'" . $park['area_in_acres'] . "' ";
   	$query .= ");";
    $mysqli->query($query);
}
